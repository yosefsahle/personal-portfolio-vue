...
<template>
    <div class="flex items-center justify-center mt-20 flex-col gap-10">
        <div class="z-2 flex md:gap-5 bg-[#0db760] w-full md:w-1/2 px-3 py-3 items-center justify-around rounded-full">
  <button
    @click="setFilter('all')"
  ...
  >
    Design
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-5 w-5/6">
  <div
    v-for="(skill, index) in filteredSkills"
    :key="index"
    class="h-40 rounded-lg shadow-lg shadow-gray-300 hover:shadow-gray-400 hover:scale-105 transition-transform duration-300 cursor-pointer"
  >
